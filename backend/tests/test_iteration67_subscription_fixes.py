...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://chutex-i18n-fix.preview.emergentagent.com')
...
class TestSubscriptionEndpoints:
    ...
    def test_billing_portal_finds_stripe_subscription_id(self):
        ...
        response = requests.post(
            ...
            headers={"Authorization": f"Bearer {self.token}"},
            json={"return_url": "https://chutex-i18n-fix.preview.emergentagent.com/profile"}
        )
