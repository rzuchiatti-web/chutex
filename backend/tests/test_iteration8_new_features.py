...
BASE_URL = os.environ.get('EXPO_PUBLIC_BACKEND_URL', 'https://care-watch-preview-1.preview.emergentagent.com')
if not BASE_URL.startswith('http'):
    BASE_URL = 'https://care-watch-preview-1.preview.emergentagent.com'
