...
async def create_saad_stripe_account(request: Request):
    ...
    if existing and existing.get("account_id"):
        ...
        link = stripe.AccountLink.create(
            ...
            refresh_url=body.get("refresh_url", "https://chutex-i18n-fix.preview.emergentagent.com"),
            return_url=body.get("return_url", "https://chutex-i18n-fix.preview.emergentagent.com"),
