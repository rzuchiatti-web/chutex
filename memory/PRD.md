...
- [x] **Light Mode par defaut beneficiaire** — Pages programmes (chat.tsx), presentation (program-detail.tsx), personnalisation (ProgramOnboarding.tsx) en Light Mode par defaut (isDark=false). Fix overflow champs personnalisation (box-sizing + overflow hidden). (2026-04-01)
- [x] **Dashboard beneficiaire restructure** — Programme repositionne apres Objectif Poids. Section Exercices avec titre "Mes exercices" + sous-titre + icone (identique aux autres sections). Fond gris #F4F4F5 uniforme sur carte programme. Carte Messages supprimee du dashboard. (2026-04-01)
- [x] **Navbar beneficiaire 5 onglets** — Ajout onglet Messages (teleconsult) avec style header rouge + contenu blanc (identique gardien/coach). Nora retirée de la navbar beneficiaire. 5 tabs: Accueil, Sante, Programmes, Messages, Plus. (2026-04-01)
