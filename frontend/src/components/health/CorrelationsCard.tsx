...
const SIMPLE_LABELS: Record<string, { text: string; icon: string; color: string }> = {
  ...
  'sleep_quality|steps': { text: 'Le sommeil influence votre activité', icon: 'ri-walk-line', color: '#10B981' },
  'steps|heart_rate': { text: 'Marcher entraine votre coeur', icon: 'ri-heart-pulse-line', color: '#EF4444' },
  'steps|stress': { text: 'L\'activité reduit votre stress', icon: 'ri-mental-health-line', color: '#F59E0B' },
  ...
  'weight|steps': { text: 'Le poids influence votre activité', icon: 'ri-walk-line', color: '#10B981' },
  ...
  'muscle_pct|basal_metabolism': { text: 'Le muscle accelere le métabolisme', icon: 'ri-fire-line', color: '#F59E0B' },
  ...
  'sleep_quality|blood_glucose': { text: 'Le sommeil agit sur la glycémie', icon: 'ri-test-tube-line', color: '#F59E0B' },
  'steps|blood_glucose': { text: 'Marcher aide a reguler la glycémie', icon: 'ri-test-tube-line', color: '#F59E0B' },
};
