...
export function CompanyInterventionsTab({ token }: { token: string }) {
  ...
  const stLabel = (st: string) => ({ pending_acceptance: t('pending'), in_progress: t('in_progress'), en_route: 'En route', completed: 'Terminee', dispatched: 'Dispatchee' }[st] || st);
