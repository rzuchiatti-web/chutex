...
const ROLE_CONTENT: Record<string, { lines: string[]; features: { icon: string; color: string; label: string; value: string; detail: string }[] }> = {
  beneficiary: {
    ...
    features: [
      ...
      { icon: 'ri-alarm-warning-line', color: '#F59E0B', label: 'Alertes', value: 'Detection intelligente', detail: 'Anomalies detectees automatiquement, vos proches alertes' },
      ...
      { icon: 'ri-calendar-check-line', color: '#A78BFA', label: 'Briefing', value: 'Chaque matin', detail: 'Un resume personnalise de votre etat et vos objectifs' },
    ],
  },
  guardian: {
    lines: [
    ...
    features: [
      { icon: 'ri-group-line', color: '#38BDF8', label: 'Suivi', value: 'Tableau de bord', detail: 'Donnees sante de vos beneficiaires en un coup d\'oeil' },
      { icon: 'ri-notification-3-line', color: '#EF4444', label: 'Alertes', value: 'Notifications push', detail: 'Prevenu immediatement en cas de chute ou anomalie' },
      ...
      { icon: 'ri-chat-smile-3-line', color: '#A78BFA', label: 'Chat Nora', value: 'Conseils adaptes', detail: 'Recommandations personnalisees pour vos proches' },
    ],
  },
  prescriber_company: {
    lines: [
    ...
    features: [
      { icon: 'ri-building-2-line', color: '#38BDF8', label: 'Gestion', value: 'Back-office complet', detail: 'Equipes, beneficiaires et intervenants en un seul endroit' },
      ...
      { icon: 'ri-bar-chart-grouped-line', color: '#F59E0B', label: 'Statistiques', value: 'Rapports detailles', detail: 'Donnees sante de votre parc de beneficiaires' },
