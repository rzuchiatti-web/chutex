  ...
  return (
    <div data-testid="nora-health-overlay" style={{
      ...
      <div style={{
        ...
        <div onClick={onClose} style={{ position: 'fixed', top: 70, left: 20, width: 40, height: 40, borderRadius: 999, background: '#FFF', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', zIndex: 100001, boxShadow: '0 4px 16px rgba(0,0,0,0.3)' } as any}>
