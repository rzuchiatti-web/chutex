        ...
        <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch' } as any}>
          ...
          <div style={{ position: 'relative', zIndex: 1 } as any}>
            ...
            <div style={{ position: 'relative', zIndex: 2, padding: '22px 20px 28px' } as any}>
              ...
              {/* Alert banner */}
              <div data-testid="alert-card" onClick={() => activeAlerts.length > 0 ? router.push({ pathname: '/alert-detail' as any, params: { alertId: activeAlerts[0].id } }) : router.push('/alerts' as any)} style={{ borderRadius: 16, padding: '14px 16px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(255,255,255,0.12)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.15)' } as any}>
