      ...
      <div style={{ width: '100%', maxWidth: 400, margin: '0 auto', padding: '40px 28px 120px', boxSizing: 'border-box' } as any}>
        ...
        {step === 2 && (
          <div style={{ textAlign: 'center' } as any}>
            ...
            <div onClick={() => { setStep(3); }} style={{ marginTop: 24, padding: '14px', borderRadius: 999, background: 'rgba(56,189,248,0.15)', border: '1px solid rgba(56,189,248,0.25)', cursor: 'pointer', fontSize: 13, fontWeight: 700, color: '#38BDF8' } as any}>{t('weighing_simulate')}</div>
            <div onClick={onClose} style={{ marginTop: 12, padding: '14px', borderRadius: 999, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', fontSize: 13, fontWeight: 700, color: 'rgba(255,255,255,0.4)' } as any}>Annuler</div>
          </div>
        )}
