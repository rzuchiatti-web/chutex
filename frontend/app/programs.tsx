        ...
        <div style={{ maxWidth: 480, margin: '0 auto', padding: 'calc(env(safe-area-inset-top, 44px) + 10px) 20px 120px' } as any}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 } as any}>
            ...
            <div style={{ flex: 1 } as any}>
              <div style={{ fontSize: 22, fontWeight: 900, color: '#FFF' }}>Programmes</div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>Parcours prevention personnalises</div>
            </div>
          </div>
          ...
          {!hasDevices && !singleProgramLock && (
            <div style={{ padding: '14px 16px', borderRadius: 16, background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.15)', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 12 } as any}>
          ...
          {singleProgramLock && (
            <div style={{ padding: '12px 14px', borderRadius: 14, background: 'rgba(14,165,233,0.06)', border: '1px solid rgba(14,165,233,0.15)', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 10 } as any}>
