                  ...
                  <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 8, marginBottom: 12 }}>
                      ...
                      <View style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.45)', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', padding: 16, alignItems: 'center', ...glass }}>
                        <Text style={{ fontSize: 18, fontWeight: '900', color: '#000' }}>{selectedPresc.subscription_type === 'standard' ? '15' : '25'}</Text>
                        <Text style={{ fontSize: 10, color: '#888', fontWeight: '700', letterSpacing: 0.5, marginTop: 2 }}>EUR/MOIS</Text>
                      </View>
                    </View>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#F5F0EB' }}>
      <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
        <Text style={{ fontSize: 22, fontWeight: '900', color: '#000', letterSpacing: -0.5 }}>Activite</Text>
        <Text style={{ fontSize: 12, color: '#888' }}>{allPrescs.length} prescriptions · {interventions.length} interventions</Text>
      </View>

      {/* Main tabs: Prescriptions / Interventions */}
      <View style={{ flexDirection: 'row', marginHorizontal: 16, backgroundColor: 'rgba(255,255,255,0.45)', borderRadius: 14, padding: 4, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', ...glass }}>
        <TouchableOpacity style={[{ flex: 1, paddingVertical: 10, alignItems: 'center', borderRadius: 11 }, tab === 'prescriptions' && { backgroundColor: '#000' }]} onPress={() => setTab('prescriptions')}>
          <Text style={{ fontSize: 13, fontWeight: '700', color: tab === 'prescriptions' ? '#FFF' : '#888' }}>Prescriptions ({allPrescs.length})</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[{ flex: 1, paddingVertical: 10, alignItems: 'center', borderRadius: 11 }, tab === 'interventions' && { backgroundColor: '#000' }]} onPress={() => setTab('interventions')}>
          <Text style={{ fontSize: 13, fontWeight: '700', color: tab === 'interventions' ? '#FFF' : '#888' }}>Interventions ({interventions.length})</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 80 }}
        ...
        {tab === 'prescriptions' && <>
          <View style={{ flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.45)', borderRadius: 14, padding: 4, marginBottom: 0, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', ...glass }}>
            <TouchableOpacity style={[{ flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: 11 }, prescTab === 'pending' && { backgroundColor: '#FF9800' }]} onPress={() => setPrescTab('pending')}>
              <Text style={{ fontSize: 12, fontWeight: '700', color: prescTab === 'pending' ? '#FFF' : '#888' }}>En cours ({pendingPrescs.length})</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[{ flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: 11 }, prescTab === 'subscribed' && { backgroundColor: '#4CAF50' }]} onPress={() => setPrescTab('subscribed')}>
              <Text style={{ fontSize: 12, fontWeight: '700', color: prescTab === 'subscribed' ? '#FFF' : '#888' }}>Validees ({subscribedPrescs.length})</Text>
            </TouchableOpacity>
          </View>
        ...
        {tab === 'interventions' && <>
          ...
          {displayedIvs.map((iv: any) => (
            <View key={iv.id} style={{ backgroundColor: 'rgba(255,255,255,0.45)', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', padding: 16, marginBottom: 12, borderLeftWidth: 4, borderLeftColor: statusColor(iv.status), ...glass }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 10 }}>
                ...
                {iv.distance_km && (
                  <View style={{ backgroundColor: 'rgba(0,0,0,0.04)', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6, alignItems: 'center' }}>
                    <Text style={{ fontSize: 14, fontWeight: '900', color: statusColor(iv.status) }}>{iv.distance_km}</Text>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, paddingTop: 10, borderTopWidth: 0.5, borderTopColor: 'rgba(0,0,0,0.04)' }}>
                ...
                <Text style={{ fontSize: 11, color: '#9C27B0', fontWeight: '600', flex: 1 }}>{iv.intervenant_name || 'Non assigne'}</Text>
                <View style={{ backgroundColor: statusColor(iv.status) + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 }}>
                  <Text style={{ fontSize: 10, fontWeight: '800', color: statusColor(iv.status) }}>{statusLabel(iv.status).toUpperCase()}</Text>
                </View>
              </View>
            </View>
          ))}
          {displayedIvs.length === 0 && (
            <View style={{ alignItems: 'center', paddingVertical: 40, backgroundColor: 'rgba(255,255,255,0.45)', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', ...glass }}>
          ...
          <View style={{ backgroundColor: '#F5F0EB', borderTopLeftRadius: 28, borderTopRightRadius: 28, maxHeight: '90%' }}>
            {selectedPresc && <>
              ...
              <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ backgroundColor: 'rgba(255,255,255,0.45)', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', padding: 18, borderLeftWidth: 4, borderLeftColor: selectedPresc.status === 'subscribed' ? '#4CAF50' : '#FF9800', alignItems: 'center', ...glass }}>
