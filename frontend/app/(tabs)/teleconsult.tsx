    ...
    return (
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column', fontFamily: 'Inter, system-ui, sans-serif', overflow: 'hidden' } as any}>
        ...
        {showIntervenantPopup && selectedIv.assigned_name && (() => {
          ...
          const ar = recipients.find((r: any) => r.id === selectedIv.assigned_to) || {};
          const pPhone = ar.phone || selectedIv.intervener_phone || '';
          const pEmail = ar.email || selectedIv.intervener_email || '';
          const pProfession = ar.profession || '';
          const pStructure = ar.structure_name || selectedIv.intervenant_structure || selectedIv.structure_name || '';
          const pAddress = ar.address || '';
