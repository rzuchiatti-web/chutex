                ...
                {(() => {
                  ...
                  return (<>
                    ...
                    {benStep === 1 && (<>
                      ...
                      <div onClick={() => { if (!benForm.firstName.trim() || !benForm.lastName.trim()) { setBenError('Prenom et nom obligatoires'); return; } if (!benForm.dob_day || !benForm.dob_month || !benForm.dob_year) { setBenError('Date de naissance obligatoire'); return; } if (!benForm.gender) { setBenError('Sexe obligatoire'); return; } setBenError(''); setBenStep(2); }} style={{ padding: '17px', borderRadius: 999, background: 'linear-gradient(135deg, #3B82F6, #2563EB)', color: '#FFF', cursor: 'pointer', textAlign: 'center', fontSize: 16, fontWeight: 800, boxShadow: '0 4px 14px rgba(59,130,246,0.3)' } as any}>Continuer</div>
                    </>)}
                    ...
                    {benStep === 2 && (<>
                      ...
                      <div onClick={() => { setBenError(''); setBenStep(3); }} style={{ padding: '17px', borderRadius: 999, background: 'linear-gradient(135deg, #3B82F6, #2563EB)', color: '#FFF', cursor: 'pointer', textAlign: 'center', fontSize: 16, fontWeight: 800, boxShadow: '0 4px 14px rgba(59,130,246,0.3)' } as any}>Continuer</div>
                    </>)}
