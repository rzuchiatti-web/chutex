...
const ZONES: Record<string, { min: number; max: number; label: string; color: string }[]> = {
  ...
  visceral_fat: [{ min: 0, max: 10, label: 'Normal', color: '#10B981' }, { min: 10, max: 15, label: 'Eleve', color: '#F59E0B' }, { min: 15, max: 25, label: 'Tres élevé', color: '#EF4444' }],
  waist_hip_ratio: [{ min: 0.5, max: 0.85, label: 'Sain', color: '#10B981' }, { min: 0.85, max: 0.95, label: 'Modéré', color: '#F59E0B' }, { min: 0.95, max: 1.2, label: 'Eleve', color: '#EF4444' }],
...
export default function MetricDétailScreen() {
  ...
  return (
    <div data-testid="metric-detail-screen" style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', fontFamily: "'Inter', system-ui, sans-serif", overflow: 'hidden', background: '#FFF' } as any}>
        ...
        <div style={{ padding: '24px 16px 120px', marginTop: -16, borderRadius: '24px 24px 0 0', background: '#FFF', position: 'relative', zIndex: 10, maxWidth: 480, margin: '-16px auto 0', width: '100%' } as any}>
          ...
          {(() => {
            const RICH_EXPLAIN: Record<string, { desc: string; why: string; ranges: { label: string; range: string; color: string }[]; tip: string; source: string }> = {
              heart_rate: { desc: t('rich_hr_desc'), why: t('rich_hr_why'), ranges: [{ label: t('rich_hr_r1'), range: '< 60 bpm', color: '#38BDF8' }, { label: t('rich_hr_r2'), range: '60 — 80 bpm', color: '#10B981' }, { label: t('rich_hr_r3'), range: '80 — 100 bpm', color: '#F59E0B' }, { label: t('rich_hr_r4'), range: '> 100 bpm', color: '#EF4444' }], tip: t('rich_hr_tip'), source: t('rich_hr_src') },
              spo2: { desc: t('rich_spo2_desc'), why: t('rich_spo2_why'), ranges: [{ label: t('rich_spo2_r1'), range: '< 90%', color: '#EF4444' }, { label: t('rich_spo2_r2'), range: '90 — 94%', color: '#F59E0B' }, { label: t('rich_spo2_r3'), range: '95 — 100%', color: '#10B981' }], tip: t('rich_spo2_tip'), source: t('rich_spo2_src') },
              blood_pressure: { desc: t('rich_bp_desc'), why: t('rich_bp_why'), ranges: [{ label: t('rich_bp_r1'), range: '< 90/60', color: '#38BDF8' }, { label: t('rich_bp_r2'), range: '90-120 / 60-80', color: '#10B981' }, { label: t('rich_bp_r3'), range: '120-140 / 80-90', color: '#F59E0B' }, { label: t('rich_bp_r4'), range: '> 140/90', color: '#EF4444' }], tip: t('rich_bp_tip'), source: t('rich_bp_src') },
              temperature: { desc: t('rich_temp_desc'), why: t('rich_temp_why'), ranges: [{ label: t('rich_temp_r1'), range: '< 35°C', color: '#38BDF8' }, { label: t('rich_temp_r2'), range: '36.1 — 37.5°C', color: '#10B981' }, { label: t('rich_temp_r3'), range: '37.5 — 38.5°C', color: '#F59E0B' }, { label: t('rich_temp_r4'), range: '> 38.5°C', color: '#EF4444' }], tip: t('rich_temp_tip'), source: t('rich_temp_src') },
              steps: { desc: t('rich_steps_desc'), why: t('rich_steps_why'), ranges: [{ label: t('rich_steps_r1'), range: '< 3 000', color: '#EF4444' }, { label: t('rich_steps_r2'), range: '3 000 — 5 000', color: '#F59E0B' }, { label: t('rich_steps_r3'), range: '5 000 — 8 000', color: '#10B981' }, { label: t('rich_steps_r4'), range: '> 8 000', color: '#3B82F6' }], tip: t('rich_steps_tip'), source: t('rich_steps_src') },
              calories: { desc: t('rich_cal_desc'), why: t('rich_cal_why'), ranges: [{ label: t('rich_cal_r1'), range: '< 150 kcal', color: '#EF4444' }, { label: t('rich_cal_r2'), range: '150 — 300 kcal', color: '#F59E0B' }, { label: t('rich_cal_r3'), range: '> 300 kcal', color: '#10B981' }], tip: t('rich_cal_tip'), source: t('rich_cal_src') },
              distance_km: { desc: t('rich_dist_desc'), why: t('rich_dist_why'), ranges: [{ label: t('rich_dist_r1'), range: '< 2 km', color: '#EF4444' }, { label: t('rich_dist_r2'), range: '2 — 4 km', color: '#F59E0B' }, { label: t('rich_dist_r3'), range: '4 — 6 km', color: '#10B981' }, { label: t('rich_dist_r4'), range: '> 6 km', color: '#3B82F6' }], tip: t('rich_dist_tip'), source: t('rich_dist_src') },
              hrv: { desc: t('rich_hrv_desc'), why: t('rich_hrv_why'), ranges: [{ label: t('rich_hrv_r1'), range: '< 20 ms', color: '#EF4444' }, { label: t('rich_hrv_r2'), range: '20 — 40 ms', color: '#F59E0B' }, { label: t('rich_hrv_r3'), range: '40 — 60 ms', color: '#10B981' }, { label: t('rich_hrv_r4'), range: '> 60 ms', color: '#3B82F6' }], tip: t('rich_hrv_tip'), source: t('rich_hrv_src') },
              stress_level: { desc: t('rich_stress_desc'), why: t('rich_stress_why'), ranges: [{ label: t('rich_stress_r1'), range: '0 — 25', color: '#10B981' }, { label: t('rich_stress_r2'), range: '25 — 50', color: '#F59E0B' }, { label: t('rich_stress_r3'), range: '50 — 75', color: '#EF4444' }, { label: t('rich_stress_r4'), range: '> 75', color: '#991B1B' }], tip: t('rich_stress_tip'), source: t('rich_stress_src') },
              recovery_score: { desc: t('rich_recovery_desc'), why: t('rich_recovery_why'), ranges: [{ label: t('rich_recovery_r1'), range: '< 40%', color: '#EF4444' }, { label: t('rich_recovery_r2'), range: '40 — 70%', color: '#F59E0B' }, { label: t('rich_recovery_r3'), range: '70 — 90%', color: '#10B981' }, { label: t('rich_recovery_r4'), range: '> 90%', color: '#3B82F6' }], tip: t('rich_recovery_tip'), source: t('rich_recovery_src') },
              sleep_quality: { desc: t('rich_sleep_desc'), why: t('rich_sleep_why'), ranges: [{ label: t('rich_sleep_r1'), range: '< 50%', color: '#EF4444' }, { label: t('rich_sleep_r2'), range: '50 — 75%', color: '#F59E0B' }, { label: t('rich_sleep_r3'), range: '75 — 90%', color: '#10B981' }, { label: t('rich_sleep_r4'), range: '> 90%', color: '#3B82F6' }], tip: t('rich_sleep_tip'), source: t('rich_sleep_src') },
              weight: { desc: t('rich_weight_desc'), why: t('rich_weight_why'), ranges: [], tip: t('rich_weight_tip'), source: t('rich_weight_src') },
              bmi: { desc: t('rich_bmi_desc'), why: t('rich_bmi_why'), ranges: [{ label: t('rich_bmi_r1'), range: '< 18.5', color: '#38BDF8' }, { label: t('rich_bmi_r2'), range: '18.5 — 25', color: '#10B981' }, { label: t('rich_bmi_r3'), range: '25 — 30', color: '#F59E0B' }, { label: t('rich_bmi_r4'), range: '> 30', color: '#EF4444' }], tip: t('rich_bmi_tip'), source: t('rich_bmi_src') },
            };
      ...
      {showNoraMetric && <NoraOverlay token={token} endpoint={`/api/nora/page-analysis?context=${key}`} title={`Analyse ${m.title?.toLowerCase()}`} subtitle={`Analyse détaillée de votre ${m.title?.toLowerCase()}`} onClose={() => setShowNoraMetric(false)} />}
