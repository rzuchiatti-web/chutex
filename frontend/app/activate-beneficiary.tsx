...
export default function ActivateBeneficiaryScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#000' }} testID="activate-beneficiary-screen">
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }}>
        ...
        <Text style={{ flex: 1, fontSize: 22, fontWeight: '900', color: 'rgba(255,255,255,0.92)' }}>Espace beneficiaire</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 40 }}>
        ...
        <Text style={{ fontSize: 11, color: 'rgba(255,255,255,0.50)', textAlign: 'center', marginBottom: 20 }}>Etape {step + 1} / 2</Text>
        ...
        {step === 0 && (
          <GlassCard>
            <Text style={{ fontSize: 18, fontWeight: '800', color: 'rgba(255,255,255,0.92)', marginBottom: 16 }}>Informations personnelles</Text>
            <WebInput label="Date de naissance" val={dob} onChange={setDob} placeholder="JJ/MM/AAAA" />
            <Text style={{ fontSize: 11, fontWeight: '700', color: 'rgba(255,255,255,0.50)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 }}>Genre</Text>
            ...
            <Text style={{ fontSize: 11, fontWeight: '700', color: 'rgba(255,255,255,0.50)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 }}>Groupe sanguin</Text>
        ...
        {step === 1 && (
          <GlassCard>
            <Text style={{ fontSize: 18, fontWeight: '800', color: 'rgba(255,255,255,0.92)', marginBottom: 16 }}>Informations medicales</Text>
            ...
            <Text style={{ fontSize: 16, fontWeight: '800', color: 'rgba(255,255,255,0.92)', marginTop: 8, marginBottom: 12 }}>Contact d'urgence</Text>
