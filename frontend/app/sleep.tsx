...
const s = StyleSheet.create({
  ...
  scoreUnit: { fontSize: 11, fontWeight: '600', color: '#000', opacity: 0.7, marginTop: -4 },
  scoreLabel: { fontSize: 16, fontWeight: '700', color: '#000' },
  scoreDuration: { fontSize: 13, color: '#000', opacity: 0.8, marginTop: 2 },
  scoreCycles: { fontSize: 12, color: '#000', opacity: 0.6, marginTop: 1 },
  // Legend
