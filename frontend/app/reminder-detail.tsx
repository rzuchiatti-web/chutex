              ...
              {rem.description && (
                <div style={{ borderRadius: 16, background: '#F4F4F5', padding: '14px 16px', marginBottom: 14 } as any}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 } as any}>
                    ...
                    <span style={{ fontSize: 11, fontWeight: 700, color: '#6B7280', textTransform: 'uppercase', letterSpacing: 0.5 }}>{t('description')}</span>
                  </div>
                ...
                {completed ? (
                  ...
                  <>
                    ...
                    <div style={{ display: 'flex', gap: 8 } as any}>
                      <div data-testid="validate-reminder-btn" onClick={() => handleComplete('done')} style={{ flex: 1, padding: '14px', borderRadius: 999, background: '#111', textAlign: 'center', cursor: 'pointer', fontSize: 14, fontWeight: 800, color: '#FFF', opacity: completing ? 0.5 : 1 } as any}>{completing ? 'Validation...' : t('dorsi_validate')}</div>
                    </div>
                  </>
                )}
              </div>
